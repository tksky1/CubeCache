...
const (
	...
	Cube_CreateCube_FullMethodName = "/Cube/CreateCube"
)
...
func (c *cubeClient) CreateCube(ctx context.Context, in *CreateCubeRequest, opts ...grpc.CallOption) (*CreateCubeResponse, error) {
	out := new(CreateCubeResponse)
	err := c.cc.Invoke(ctx, Cube_CreateCube_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCubeServer) CreateCube(context.Context, *CreateCubeRequest) (*CreateCubeResponse, error) {
...
func _Cube_CreateCube_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateCubeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CubeServer).CreateCube(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Cube_CreateCube_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CubeServer).CreateCube(ctx, req.(*CreateCubeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Cube_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Cube_CreateCube_Handler,
		},
	},
